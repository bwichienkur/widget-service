...
{
    public class GPExitPopModel : IRenderable
    {
        ...
        public GPExitPopModel(IConfiguration configuration, IFileSerializeService fileSerializeService,WidgetRequest widgetRequest)
        {
        ...
        {          
            ...
            renderedJs += (await viewRenderService.RenderToStringAsync(WidgetType.GPExitPop, "ExitPopDependencies", this, true)).Replace("&#xD", string.Empty).Replace("&#xA", string.Empty);
            renderedJs += await viewRenderService.RenderToStringAsync(WidgetType.GPExitPop, "ExitPop", this, true);
